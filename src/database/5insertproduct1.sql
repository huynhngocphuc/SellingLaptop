...
insert into product(product_name,image,price,describe_pro,detail_cate_id,brand_id,quantity)
values
("Chuột máy tính Newmen M266 đen","NewmenM266.jpg",5000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',13,15,10),
("Chuột máy tính không dây Newmen F266 (Vàng)","NewmenF266.jpg",5000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',13,15,8),
("Chuột máy tính không dây Newmen F430 (Đen)","NewmenF430.jpg",5000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',13,15,9);
# chuot Microsoft
insert into product(product_name,image,price,describe_pro,detail_cate_id,brand_id,quantity)
values
("Chuột không dây Microsoft RJN-00017","RJN-00017.jpg",1000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',12,15,10),
("Chuột có dây Microsoft Classic Intellimouse","MicrosoftClassicIntellimouse.jpg",4000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',12,15,10),
("Chuột không dây Microsoft Arc ELG-00005 (Đen)","MicrosoftArcELG-00005.jpg",2000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',12,15,10);
...
insert into product(product_name,image,price,describe_pro,detail_cate_id,brand_id,quantity)
values
("Bàn phím Akko 3108S RGB PRO Blue Switch (108 keys) (Hồng)","Akko3108S.jpg",1000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',18,15,15),
("Bàn phím AKKO 3087 World Tour - Tokyo Switch Pink (87 keys)","AKKO3087.jpg",1000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',18,15,11),
("Bàn phím cơ Akko 3108 Dragon Ball Z - Goku Orange Switch","Akko3108.jpg",1000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',18,15,4);

#id  tai nghe  JBL
insert into product(product_name,image,price,describe_pro,detail_cate_id,brand_id,quantity)
values
("Tai nghe Gaming JBL QUANTUM 400 ( Đen)","GamingJBLQUANTUM400.jpg",1200000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',19,15,15),
("Tai nghe On-ear JBL T500 (Xanh dương)","OnEarJBLT500.jpg",1400000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',19,15,15),
("Tai Nghe Bluetooth JBL Tune T220TWSBLK (Đen)","BLTuneT220TWSBLK.jpg",1000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',19,15,15);


#id 17 tai nghe  Sony
insert into product(product_name,image,price,describe_pro,detail_cate_id,brand_id,quantity)
values
("Tai nghe Sony MDR-XB550AP (Đỏ)","SonyMDRXB550AP.jpg",1200000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',20,15,10),
("Tai nghe On-ear Sony MDRZX310APLCE (Xanh dương)","SonyMDRZX310APLCE.png",1400000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',20,15,9),
("Tai nghe không dây In-ear Sony WI-SP500/BQE (Đen)","SonyWISP500.jpg",1000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',20,15,15);
#id 18 tai nghe PHILIPS
insert into product(product_name,image,price,describe_pro,detail_cate_id,brand_id,quantity)
values
("Tai nghe Over-ear Philips SHP 2000 (Đen)","PhilipsSHP2000.jpg",1000000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',21,15,8),
("Tai nghe On-ear Philips SHL 3060 (Xanh)","PhilipsSHL3060.jpg",1200000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',21,15,2),
("Tai nghe On-ear Philips SHM6110U (Trắng)","PhilipsSHM6110U.jpg",1600000,'Bảo hành  siêu nhanh: bảo hành nhanh, trong vòng 3 ngày kể cả thứ 7 và chủ nhật',21,15,2);
